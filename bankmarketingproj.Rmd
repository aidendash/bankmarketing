...
new.train = train.data %>% 
  select(-default, -contact, -loan) # new training data without 'default', 'contact', and 'loan'.

new.test = test.data %>% 
  select(-default, -contact, -loan) # new test data without 'default', 'contact', and 'loan'.
